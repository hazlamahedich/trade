    ...
    <section className="px-6 py-16" aria-labelledby="value-prop-heading">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center sm:gap-6">
          <div className="flex items-center gap-2 rounded-lg bg-slate-800 border border-glass px-4 py-3">
            <span className="text-sm font-medium text-slate-400">Raw Data</span>
          </div>
          <svg width="24" height="24" viewBox="0 0 24 24" className="text-secondary-safe rotate-90 sm:rotate-0" aria-hidden="true">
